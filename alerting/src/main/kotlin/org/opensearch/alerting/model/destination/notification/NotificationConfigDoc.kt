 ...
 *
 */
package org.opensearch.alerting.model.notification

import org.opensearch.alerting.model.notification.DocMetadata.Companion.METADATA_TAG
 ...
 * Copied from Notification plugin and is used to parse hits from search queries on Notification config index.
 * Used for searchEmailGroup and SearchEmailAccount APIs
 */
data class NotificationConfigDoc(
    ...
    companion object {
        ...
        fun parse(parser: XContentParser): NotificationConfigDoc {
            ...
            metadata ?: throw IllegalArgumentException("metadata field absent")
